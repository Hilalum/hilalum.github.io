---
layout: page
title: Privacy Policy for RoomBoard
...
The App interacts with **Home Assistant** via its official API.

*   **Home Assistant**: As a client, the functionality of this App relies on your personal Home Assistant service. For privacy practices regarding Home Assistant itself, please refer to its official documentation; however, this typically depends on your own server configuration.

## Changes to This Privacy Policy

Although we do not strictly collect any data at present, we will update this privacy policy if the App's functionality changes significantly in the future (e.g., introducing new features requiring cloud support). Any changes will be posted on this page with an updated "Last Updated" date.

## Contact Us

If you have any questions about this privacy policy or concerns about the security of the App, please contact us at:

*   Email: [dcyap0@icloud.com](mailto:dcyap0@icloud.com)
