...
layout: post
title: 后端预制菜 - GraphQL
display_title: "后端预制菜 · GraphQL"
subtitle: "一份写给自己的 GraphQL 入门"
read_minutes: 7
...
然而，在传统的 REST API 模式下，我们常常面临一些困扰：
...
GraphQL的出现，为后端开发提供了“预制菜”式的便利，使数据查询变得更高效灵活。通过其强大的查询语言、灵活的数据结构和强大的工具生态，GraphQL正成为现代 API 设计的首选方案之一，在国际化公司中尤其流行。如果你的项目面临多端数据需求复杂、接口变更频繁的问题，不妨试试GraphQL，说不定它正是你的“理想菜谱”！
